...
import 'package:flutter_exchange/data/CoinData.dart';
import 'package:flutter_exchange/utils/HttpCore.dart';
import 'package:flutter_exchange/contants/Api.dart';
import 'package:flutter_exchange/exchange/Quotes.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void refreshDataFromNet() {
    HttpCore.instance.get(Api.tickers, (data) {
      countDown();
      setState(() {
        datas = CoinData.fromJson(data).data;
      });
    }, errorCallBack: (error) {
  ...
  Widget exchangeItem() {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) => Container(
              child: Quotes(coinInfo: datas[index]),
            ));
  }
